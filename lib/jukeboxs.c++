...
void jukeboxs(string key)
{
  ...
  command = "youtube-dl --no-warnings -q -o - https://www.youtube.com" + results.str() + "| ffmpeg -loglevel quiet -i - -f mp3 -id3v2_version 3 pipe:1 | mpg123 -q -";
